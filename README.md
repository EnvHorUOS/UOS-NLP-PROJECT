...
| 신민경 | 이번 프로젝트는 Bioinformatics와 AI를 처음으로 융합해 보았다는 점, 논문 분석을 기반으로 task를 설계하고, 데이터 전처리와 모델 적용을 거쳐 분석에 이르기까지 AI 기반 도구를 개발하는 모든 과정을 한 번에 경험해 보았다는 점에서 의미 있는 프로젝트였다. 이 경험을 발판 삼아 앞으로도 Bioinformatics에 NLP를 포함한 AI 기술을 적용하는 다양한 프로젝트를 진행해 보고자 한다. |
<br>
<br>
