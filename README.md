...
| 신민경 | 각각 공부하고 있었던 Bioinformatics와 AI를 처음으로 융합해 보았다는 점, 논문 분석을 통한 task 선정부터, 전처리, 모델 적용, 분석까지 AI tool을 만드는 full cycle을 경험해 보았다는 점에서 굉장히 의미있는 프로젝트였다. 이 경험을 발판 삼아 앞으로도 Bioinformatics에 NLP를 포함한 AI를 적용하는 다양한 프로젝트를 진행해보고자 한다. |
<br>
<br>
